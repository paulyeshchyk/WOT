...
public extension VehicleprofileAmmo {
    ...
    override func decode(using map: JSONCollectionContainerProtocol, managedObjectContextContainer: ManagedObjectContextContainerProtocol, appContext: JSONDecodableProtocol.Context) throws {
        ...
        if let jsonCustom = ammoJSON[keypathPenetration] {
            ...
            appContext.logInspector?.log(.warning(error: VehicleprofileAmmoError.noPenetration))
        }
        ...
        if let jsonCustom = ammoJSON[keypathDamage] {
            ...
            appContext.logInspector?.log(.warning(error: VehicleprofileAmmoError.noDamage))
        }
    }
}
