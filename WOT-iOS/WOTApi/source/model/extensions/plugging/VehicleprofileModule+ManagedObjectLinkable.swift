...
extension VehicleprofileModule: ManagedObjectPlugProtocol {
    ...
    public func plug(pin: ManagedObjectPinProtocol?, intoSocket: JointSocketProtocol?) {
        ...
        default:
            assertionFailure("undefiend field \(String(describing: intoSocket, orValue: "<NULLpublic func plug(pin: ManagedObjectPinProtocol, intoSocket _: JointSocketProtocol)>"))")
        }
