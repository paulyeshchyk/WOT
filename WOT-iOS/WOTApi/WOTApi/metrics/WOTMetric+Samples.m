...
//                                      withName:WOTString(WOTApiFields.rotation_speed)
...
//                                      withName:WOTString(WOTApiFields.fire_starting_chance)
//                                     groupName:WOTString(WOT_STRING_MOBI)];
//}
//
...
//                                      withName:WOTString(WOTApiFields.circular_vision_radius)
...
//                                      withName:WOTString(WOTApiFields.armor_board)
...
//                                      withName:WOTString(WOTApiFields.armor_fedd)
//                                     groupName:WOTString(WOT_STRING_ARMOR)];
//}
//
...
//                                      withName:WOTString(WOTApiFields.armor_forehead)
//                                     groupName:WOTString(WOT_STRING_ARMOR)];
//}
