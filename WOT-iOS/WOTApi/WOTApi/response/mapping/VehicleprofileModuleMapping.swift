...
extension VehicleprofileModule {
    ...
    override public func mapping(with map: JSONManagedObjectMapProtocol, appContext: JSONMappableProtocol.Context) throws {
        ...
        if let gun_id = self.gun_id {
            ...
            try appContext.requestManager?.fetchRemote(requestParadigm: gunRequestParadigm, requestPredicateComposer: gunPredicateComposer, managedObjectCreator: gunJSONAdapter, listener: self)
        }
        ...
        if let radio_id = self.radio_id {
            ...
            try appContext.requestManager?.fetchRemote(requestParadigm: radioRequestParadigm, requestPredicateComposer: radioPredicateComposer, managedObjectCreator: radioJSONAdapter, listener: self)
        }
        ...
        if let engine_id = self.engine_id {
            ...
            try appContext.requestManager?.fetchRemote(requestParadigm: engineRequstParadigm, requestPredicateComposer: enginePredicateComposer, managedObjectCreator: engineJSONAdapter, listener: self)
        }
        ...
        if let suspension_id = self.suspension_id {
            ...
            try appContext.requestManager?.fetchRemote(requestParadigm: suspensionRequestParadigm, requestPredicateComposer: suspensionPredicateComposer, managedObjectCreator: suspensionJSONAdapter, listener: self)
        }
        ...
        if let turret_id = self.turret_id {
            ...
            try appContext.requestManager?.fetchRemote(requestParadigm: turretRequestParadigm, requestPredicateComposer: turretPredicateComposer, managedObjectCreator: turretJSONAdapter, listener: self)
        }
    }
}
