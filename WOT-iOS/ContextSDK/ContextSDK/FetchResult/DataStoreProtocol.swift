...
public protocol DataStoreProtocol {
    ...
    func fetchLocal(objectContext: ManagedObjectContextProtocol, byModelClass clazz: AnyObject, predicate: RequestPredicate, completion: @escaping FetchResultCompletion)
