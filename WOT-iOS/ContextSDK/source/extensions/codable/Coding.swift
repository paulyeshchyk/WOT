    ...
    func decodeArray<T: Decodable>(_ key: K) throws -> [T] {
        ...
        while !container.isAtEnd {
            do {
                ...
                if CodingAPI.safeArrayDecoding {
...
public struct DateTime: Codable, Comparable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        // Support parsing old date time strings saved using 12 hour time.
        for formatter in DateTime.dateDecodingFormatters {
...
extension DateTime {
    func encode() -> Any {
        return DateTime.dateEncodingFormatter.iso8601.string(from: date)
    }
}
