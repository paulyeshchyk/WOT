...
class WOTPivotTemplateVehicleTier: NSObject, WOTPivotTemplateProtocol {
    ...
    func asType(_ type: PivotMetadataType) -> WOTPivotNodeProtocol {
        ...
        result.addChild(pivotNodeClass.init(name: "I", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "1")))
        result.addChild(pivotNodeClass.init(name: "II", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "2")))
        result.addChild(pivotNodeClass.init(name: "III", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "3")))
        result.addChild(pivotNodeClass.init(name: "IV", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "4")))
        result.addChild(pivotNodeClass.init(name: "V", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "5")))
        result.addChild(pivotNodeClass.init(name: "VI", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "6")))
        result.addChild(pivotNodeClass.init(name: "VII", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "7")))
        result.addChild(pivotNodeClass.init(name: "VIII", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "8")))
        result.addChild(pivotNodeClass.init(name: "IX", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "9")))
        result.addChild(pivotNodeClass.init(name: "X", predicate: NSPredicate(format: "%K == CAST(%@,'NSDecimalNumber')", WOTApiKeys.level, "10")))
...
class WOTPivotTemplateVehicleDPM: NSObject, WOTPivotTemplateProtocol {
    ...
    func asType(_ type: PivotMetadataType) -> WOTPivotNodeProtocol {
        ...
        let predicateLess100 = NSCompoundPredicate(andPredicateWithSubpredicates: [NSPredicate(format: "%K < CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 100)])
        let predicateLess200 = NSCompoundPredicate(andPredicateWithSubpredicates: [NSPredicate(format: "%K >= CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 100), NSPredicate(format: "%K < CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 200)])
        let predicateLess500 = NSCompoundPredicate(andPredicateWithSubpredicates: [NSPredicate(format: "%K >= CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 200), NSPredicate(format: "%K < CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 500)])
        let predicateLess1000 = NSCompoundPredicate(andPredicateWithSubpredicates: [NSPredicate(format: "%K >= CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 500), NSPredicate(format: "%K < CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 1000)])
        let predicateLess2000 = NSCompoundPredicate(andPredicateWithSubpredicates: [NSPredicate(format: "%K >= CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 1000), NSPredicate(format: "%K < CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 2000)])
        let predicateLess3000 = NSCompoundPredicate(andPredicateWithSubpredicates: [NSPredicate(format: "%K >= CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 2000), NSPredicate(format: "%K < CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 3000)])
        let predicateGr3000 = NSCompoundPredicate(andPredicateWithSubpredicates: [NSPredicate(format: "%K >= CAST(%d, 'NSDecimalNumber')", "vehicles.default_profile.gun.fire_rate", 3000)])
