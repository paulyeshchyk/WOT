//
//  VehicleProfileTurretLocalJSONAdapterHelper.swift
//  WOTData
//
...
@objc
public class VehicleProfileTurretLocalJSONAdapterHelper: NSObject, JSONAdapterInstanceHelper {
    ...
    public func onInstanceDidParse(fetchResult: FetchResult) {
        ...
        self.vehicleProfile.turret = turret
