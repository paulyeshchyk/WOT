...
protocol WOTDimensionCalculatorProtocol: NSObjectProtocol {
    static func rectangle(forNode: WOTNodeProtocol, dimension: WOTDimensionProtocol) -> CGRect
}
...
class WOTDimensionCalculator: NSObject, WOTDimensionCalculatorProtocol {
    ...
    class func width(forNode: WOTNodeProtocol, dimension: WOTDimensionProtocol) -> Int { return 0 }
    class func height(forNode: WOTNodeProtocol, dimension: WOTDimensionProtocol) -> Int { return 0 }
}
