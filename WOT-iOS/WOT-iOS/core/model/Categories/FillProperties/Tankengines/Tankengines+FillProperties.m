...
+ (NSArray *)availableFields {
    ...
    return @[WOT_KEY_NAME_I18N,WOT_KEY_NAME,WOT_KEY_PRICE_GOLD, WOT_KEY_LEVEL, WOT_KEY_NATION, WOT_KEY_POWER, WOT_KEY_PRICE_CREDIT, WOT_KEY_FIRE_STARTING_CHANCE, WOT_KEY_MODULE_ID, WOT_KEY_NATION_I18N];
}
