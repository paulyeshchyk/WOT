...
+ (NSArray *)availableFields {
    ...
    return @[WOT_KEY_NAME, WOT_KEY_MODULE_ID, WOT_KEY_ARMOR_BOARD, WOT_KEY_ARMOR_FEDD, WOT_KEY_ARMOR_FOREHEAD, WOT_KEY_CIRCULAR_VISION_RADIUS, WOT_KEY_LEVEL, WOT_KEY_NAME_I18N, WOT_KEY_NATION, WOT_KEY_PRICE_CREDIT, WOT_KEY_PRICE_GOLD, WOT_KEY_ROTATION_SPEED];
}
