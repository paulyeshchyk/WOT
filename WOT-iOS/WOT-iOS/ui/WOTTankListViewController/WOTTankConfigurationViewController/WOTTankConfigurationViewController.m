...
- (void)viewDidLoad {
    ...
    WOTNode *node0 = [[WOTNode alloc] initWithName:@"0" parent:nil];
    WOTNode *node00 = [[WOTNode alloc] initWithName:@"0.0" parent:node0];
    WOTNode *node01 = [[WOTNode alloc] initWithName:@"0.1" parent:node0];
    WOTNode *node02 = [[WOTNode alloc] initWithName:@"0.2" parent:node0];
    [node0 addChild:node00];
    [node0 addChild:node01];
    [node0 addChild:node02];

    WOTNode *node010 = [[WOTNode alloc] initWithName:@"0.1.0" parent:node01];
    WOTNode *node011 = [[WOTNode alloc] initWithName:@"0.1.1" parent:node01];
    WOTNode *node012 = [[WOTNode alloc] initWithName:@"0.1.2" parent:node01];
    WOTNode *node013 = [[WOTNode alloc] initWithName:@"0.1.3" parent:node01];
    [node01 addChild:node010];
    [node01 addChild:node011];
    [node01 addChild:node012];
    [node01 addChild:node013];

    WOTNode *node0110 = [[WOTNode alloc] initWithName:@"0.1.1.0" parent:node011];
    WOTNode *node0111 = [[WOTNode alloc] initWithName:@"0.1.1.1" parent:node011];
    [node011 addChild:node0110];
    [node011 addChild:node0111];

    WOTNode *node01110 = [[WOTNode alloc] initWithName:@"0.1.1.1.0" parent:node0111];
    WOTNode *node01111 = [[WOTNode alloc] initWithName:@"0.1.1.1.1" parent:node0111];
    ...
    WOTNode *node0210 = [[WOTNode alloc] initWithName:@"0.2.1.0" parent:node020];
