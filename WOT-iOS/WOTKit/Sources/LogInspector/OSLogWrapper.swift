...
extension LOGOutputProtocol {
    ...
    public func debug(_ message: Any, _ file: String = #file, _ function: String = #function, line: Int = #line, context: LogContext? = nil) {
        self.debug(message, file, function, line: line, context: context)
    }

    public func info(_ message: Any, _ file: String = #file, _ function: String = #function, line: Int = #line, context: LogContext? = nil) {
        self.info(message, file, function, line: line, context: context)
    }

    public func warning(_ message: Any, _ file: String = #file, _ function: String = #function, line: Int = #line, context: LogContext? = nil) {
        self.warning(message, file, function, line: line, context: context)
    }

    public func error(_ message: Any, _ file: String = #file, _ function: String = #function, line: Int = #line, context: LogContext? = nil) {
        self.error(message, file, function, line: line, context: context)
    }
